...
public class InquirySearchVO {
	private String filter = "전체"; // 기본값은 'all'
	...
	public InquirySearchVO(String filter, String field, String keyword, String startDate, String endDate, int currentPage,
