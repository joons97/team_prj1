...
<body>
	...
	<div class="main-content">
		...
		<div class="contentTop">
			...
			<div class="innerBox">
				<img src="http://egoempo.sist.co.kr/common/img/img1.png"
					style="float: left;">
				<p>
					신규주문
					<%=newOrderCnt%>
			...
			<div class="innerBox">
				<img src="http://egoempo.sist.co.kr/common/img/img2.png"
					style="float: left;">
				<p>배송 상태</p>
		...
		<div class="contentTop">
			...
			<div class="innerBox">
				<img src="http://egoempo.sist.co.kr/common/img/img3.png"
					style="float: left;">
				<p>
					취소요청
					<%=cancelCnt%>
			...
			<div class="innerBox">
				<img src="http://egoempo.sist.co.kr/common/img/img4.png"
					style="float: left;">
				<p>
					구매확정
					<%=confirmedCnt%>
		...
		<div class="contentBottom">
			...
			<div class="innerBox">
				<img src="http://egoempo.sist.co.kr/common/img/img5.png"
					style="float: left;">
				<p>
					총회원
					<%=totalMemberCnt%>
			...
			<div class="innerBox">
				<img src="http://egoempo.sist.co.kr/common/img/img6.png"
					style="float: left;">
				<p>
					미답변문의
					<%=inquiryCnt%>
