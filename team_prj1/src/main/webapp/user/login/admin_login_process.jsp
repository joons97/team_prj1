...
<%@ page import="kr.co.sist.project.admin.AdminAuthenticationDAO" %>
<%@ page import="kr.co.sist.project.admin.AdminVO" %>
...
<jsp:useBean id="aVO" class="kr.co.sist.project.admin.AdminVO" scope="page"/>
