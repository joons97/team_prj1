...
<%@ page import="kr.co.sist.project.user.UserNoticeDAO" %>
<%@ page import="kr.co.sist.project.user.NoticeVO" %>
...
<div class="content">
<jsp:useBean id="sVO" class="kr.co.sist.project.user.SearchVO" scope="page"/>
...
<table>
	...
	<tr>
		...
		<td><a href="notice_detail_page.jsp?notice_id=${ nVO.noticeId }&currentPage=${ currentPage }${ searchParam }"><c:out value="${ nVO.title }"/></a></td>
...
<form action="notification.jsp" method="get" name="searchFrm" id="searchFrm">
