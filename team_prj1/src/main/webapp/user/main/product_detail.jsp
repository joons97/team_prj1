<%@ page import="kr.co.sist.project.user.UserProductDAO" %>
<%@ page import="kr.co.sist.project.user.ProductVO" %>
<%@ page import="java.util.List" %>
<%@ page import="kr.co.sist.project.user.ReviewVO" %>
<%@ page import="kr.co.sist.project.user.SizeVO" %>
...
<head>
  ...
  <link rel="stylesheet" href="http://egoempo.sist.co.kr/user/css/product_details.css">
  <link rel="stylesheet" href="http://egoempo.sist.co.kr/user/css/review.css">
...
<div class="product-container">
  ...
  <!-- 메인 이미지 -->
   <div class="main-image">
     <img src="http://egoempo.sist.co.kr/common/images/${product.mainImg}" alt="${product.name}" id="mainImage">
   </div>
   <!-- 서브 이미지들 -->
   <div class="sub-images">
     <!-- 메인 이미지도 서브 이미지 목록에 포함 -->
     <div class="sub-image active" onclick="changeImage(this, '${product.mainImg}')">
       <img src="http://egoempo.sist.co.kr/common/images/${product.mainImg}" alt="${product.name}">
     </div>
     <!-- 서브 이미지들 -->
     <c:if test="${not empty product.subImgList}">
       <c:forEach var="subImg" items="${product.subImgList}">
         <div class="sub-image" onclick="changeImage(this, '${subImg}')">
           <img src="http://egoempo.sist.co.kr/common/images/${subImg}" alt="${product.name}">
         </div>
       </c:forEach>
     </c:if>
   </div>
          ...
          <div class="review">
            ...
            <div class="review-body">
              ...
              <div class="review-image">
                <img src="http://egoempo.sist.co.kr/common/review_images/${review.reviewImg}" alt="리뷰 이미지">
              </div>
            </div>
          </div>
        </c:forEach>
...
<script>
    ...
    function changeImage(element, imgSrc) {
        // 메인 이미지 변경
        document.getElementById('mainImage').src = 'http://egoempo.sist.co.kr/common/images/' + imgSrc;
        // active 클래스 관리
