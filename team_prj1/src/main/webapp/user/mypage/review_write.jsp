...
<%@ page import="kr.co.sist.project.user.OrderDAO" %>
    ...
    <div class="review-container">
        <form id="reviewForm" action="review_process.jsp" method="post" enctype="multipart/form-data">
		    ...
		    <%
		        ...
		        String imagePath = "http://egoempo.sist.co.kr/common/images/" + imgName;
		        
		    %>
		    <img src="<%= imagePath %>"
		         alt="<%= imgName %>"
		         onerror="this.onerror=null; this.src='http://egoempo.sist.co.kr/common/images/no-image.png';" />
	        ...
	        <div class="button-container">
	            <button type="button" class="cancel" onclick="location.href='http://egoempo.sist.co.kr/index.jsp'">취소</button>
        ...
        function submitReview() {
        	  ...
        	  $.ajax({
        	    ...
        	    success: function(response) {
        	        alert('리뷰가 등록되었습니다.');
        	        window.location.href = 'http://egoempo.sist.co.kr/index.jsp';
        	    },
