...
<%@ page import="kr.co.sist.project.user.*"%>
<%@ page import="kr.co.sist.project.user.*"%>
...
<title>주문/결제</title>
<link rel="stylesheet"
	href="http://egoempo.sist.co.kr/user/css/payment.css">
<link rel="stylesheet"
	href="http://egoempo.sist.co.kr/user/css/modal.css">
<script
	...
	<div class="container">
		<div class="main-content">
			...
			<section class="order-summary">
				...
				<div class="product">
					<img
						src="http://egoempo.sist.co.kr/common/images/${product.mainImg}"
						alt="${product.name}">
