...
<script type="text/javascript">
	function confirmLogout() {
		...
		if (confirm(adminId + "님 로그아웃 하시겠습니까?")) {
			window.location.href = "http://egoempo.sist.co.kr/common/jsp/logout.jsp";
		}
	}
</script>
...
<div class="header"
	...
	<span><a href="http://egoempo.sist.co.kr/manage/admin_main.jsp">스마트스토어
			센터</a></span>
	<div class="admin_div">
	...
	<div class="accordion" id="accordionSidebar">
		...
		<div class="accordion-item">
			...
			<div id="collapseOne" class="accordion-collapse collapse"
				...
				<div class="accordion-body">
					<a href="http://egoempo.sist.co.kr/manage/product/productList.jsp">상품
						리스트</a> <a
						href="http://egoempo.sist.co.kr/manage/product/productRegistration.jsp">상품
						등록</a>
				</div>
			</div>
		</div>
		...
		<div class="accordion-item">
			...
			<div id="collapseTwo" class="accordion-collapse collapse"
				...
				<div class="accordion-body">
					<a href="http://egoempo.sist.co.kr/manage/sales/salesList.jsp">판매
						리스트</a>
				</div>
			</div>
		</div>
		...
		<div class="accordion-item">
			...
			<div id="collapseFour" class="accordion-collapse collapse"
				...
				<div class="accordion-body">
					<a
						href="http://egoempo.sist.co.kr/manage/inquiry/admin_inquiry.jsp">문의
						리스트</a>
				</div>
			</div>
		</div>
		...
		<div class="accordion-item">
			...
			<div id="collapseFive" class="accordion-collapse collapse"
				...
				<div class="accordion-body">
					<a href="http://egoempo.sist.co.kr/manage/review/admin_review.jsp">리뷰
						리스트</a>
				</div>
			</div>
		</div>
		...
		<div class="accordion-item">
			...
			<div id="collapseSix" class="accordion-collapse collapse"
				...
				<div class="accordion-body">
					<a href="http://egoempo.sist.co.kr/manage/notice/notice_list.jsp">공지사항
						리스트</a> <a
						href="http://egoempo.sist.co.kr/manage/notice/notice_add.jsp">공지사항
						등록</a>
				</div>
			</div>
		</div>
		...
		<div class="accordion-item">
			...
			<div id="collapseSeven" class="accordion-collapse collapse"
				...
				<div class="accordion-body">
					<a href="http://egoempo.sist.co.kr/manage/member/memberList.jsp">회원
						목록</a>
				</div>
			</div>
		</div>
